...
function Highlighter() {
  this.init = () => {
    this.keyword = [{
      name: 'keyword',
      keys: [
        'DPRNT', 'POPEN', 'PCLOS', 'SETVN', 'BSHAPE', 'ESHAPE', 'WHILE', 'IF', 'GOTO', 'THEN', 'END', 'DO', 'ELSE', 'POCKET', 'TOOL', 'SLOT', 'CYCLE', 'PATTERN', 'SURFACE', 'SHOULDER', 'SET', 'SETTOOL', 'DELTOOL', 'THREADING', 'DRILLING', 'BORING', 'MIRROR', 'SHIFT', 'ZOOM', 'ROTATE', 'CUSTOM'
      ],
